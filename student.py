...
#first image
        img=Image.open("D:\\photos\\image.jfif")
...
#second image
        img1=Image.open("D:\\photos\\image2.jfif")
...
#third image
        img2=Image.open("D:\\photos\\download.jfif")
...
#background image
        img3=Image.open("D:\\photos\\back.jfif")
...
#left label frame
        ...
        img_left=Image.open("D:\\photos\\code.jpg")
...
#current course information
        ...
        course_combo["values"]=("Select course","JAVA","PYTHON","C","C++")
...
#class Student information
        ...
        class_Student_frame.place(x=10,y=250,width=720,height=320)
        ...
        btn_frame.place(x=0,y=220,width=715,heigh=35)
        ...
        btn_frame1.place(x=0,y=255,width=715,heigh=35)
...
#Right label frame
        ...
        img_right=Image.open("D:\\photos\\code.jpg")
        img_right=img.resize((740,130),Image.ANTIALIAS)
...
#======================Search System===========================
        ...
        search_label=Label(Current_course_frame,text="search",font=("times new roman",13,"bold"),bg="white")
        ...
        search_combo["values"]=("Select ","Roll_No","Phone_N0")
...
#==============================function declaration========================================
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host="localhost",username="root",password="vik@s",database="face_recognition")      #inspite of face_recogniser i used face_recognition video time 19:03  video 3
        ...
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                if Upadate>0:
                    ...
                    if not Upadate:
                        return
                messagebox.showinfo("Success","Student detils has been added Updated",parent=self.root)
                conn.commit()
                self.fetch_data()
                conn.close()
            except Exception as es:
    ...
    def generate_dataset(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                face_classifier=cv2.CascadeClassifier(r"C:\Python 3.10\Lib\site-packages\cv2\data\haarcascade_frontalface_default.xml")
