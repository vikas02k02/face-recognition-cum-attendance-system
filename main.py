...
#student details button
        img4=Image.open("D:\\photos\\det.png")
...
#train data button
        img8=Image.open("D:\\photos\\train.jfif")
...
#Face Detector button
        img9=Image.open("D:\\photos\\fa.jfif")
        img9=img9.resize((220,220),Image.ANTIALIAS)
        self.photoimg9=ImageTk.PhotoImage(img9)

        b7=Button(bg_img,image=self.photoimg9,cursor="hand2",command=self.face_data)
...
#attendance button
        img7=Image.open("D:\\photos\\att.jfif")
        img7=img7.resize((220,220),Image.ANTIALIAS)
        self.photoimg7=ImageTk.PhotoImage(img7)

        b4=Button(bg_img,image=self.photoimg7,cursor="hand2",command=self.attendance_data)
        b4.place(x=1100,y=100,width=220,height=220)

        b4_4=Button(bg_img,text="Attendance",command=self.attendance_data,cursor="hand2",font=("times new roman",14,"bold"),bg="darkblue",fg="white")
        b4_4.place(x=1100,y=300,width=220,height=40)                               


#Photos button
        img5=Image.open("D:\\photos\\pho.jfif")
...
#Exit button
        img6=Image.open("D:\\photos\\exit.jfif")
        img6=img6.resize((220,220),Image.ANTIALIAS)
        self.photoimg6=ImageTk.PhotoImage(img6)

        b3=Button(bg_img,image=self.photoimg6,command=self.Close,cursor="hand2")
        b3.place(x=800,y=380,width=220,height=220)

        b3_3=Button(bg_img,text="Exit",cursor="hand2",command=self.Close,font=("times new roman",15,"bold"),bg="darkblue",fg="white")
        b3_3.place(x=800,y=580,width=220,height=40)


#============photos button backend=============
